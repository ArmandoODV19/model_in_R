...
Las cadenas de Markov pemiten conocer la probabilidad de que suceda un evento dado la aparición de un evento previo. Para esto se necesitan las siguientes caracterísitcas:
...
Para ello, se define como un estado a los posibles eventos que puedan ocurrir en un experimento. Cabe destacar que debe conocerce la probabilidad de ocurrencia de cada evento.
