...
```{r imagen1, echo=FALSE, out.width = "70%", fig.align = "center"}
knitr::include_graphics(path = "nuevo_proyecto.png")
```


Se generará un apartado para nuestro nuevo proyecto. Por el momento nos enfocaremos solo en 'New directory'
