...
La estadística descriptiva suele ser el primer acercamiento analítico para entender el comportamiento de los datos. Visto de otra manera, se considera como un resumen de las variables más comunes de los datos. Entre ellas se destaca el valor máximo, mínimo, rango, media aritmética, mediana, moda, varianza, desviación estándar. Por mencionar algunos.


Por su parte, la estadística inferencial se encarga de generar predicciones a partir de los datos 
